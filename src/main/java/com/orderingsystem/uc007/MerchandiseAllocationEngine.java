 ...
 */
final class MerchandiseAllocationEngine {

    private MerchandiseAllocationEngine() {
    }

    record SitePool(String siteCode, int stock) {
    }

    record AllocationLine(String siteCode, DeliveryMeans deliveryMeans, int quantity) {
    }

    record Plan(List<AllocationLine> lines, int shortfall, boolean hasNoEligibleSite) {
